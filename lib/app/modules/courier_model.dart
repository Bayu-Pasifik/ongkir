...
class CourierModel {
    ...
    factory CourierModel.fromJson(Map<String, dynamic> json) => CourierModel(
        code: json["code"],
        name: json["name"],
        costs: List<CourierModelCost>.from(json["costs"].map((x) => CourierModelCost.fromJson(x))),
    );
...
class CourierModelCost {
    ...
    factory CourierModelCost.fromJson(Map<String, dynamic> json) => CourierModelCost(
